...
interface OrganizerPasswordResetFormProps {
  showBackToLogin?: boolean;
}

export function OrganizerPasswordResetForm({ showBackToLogin = true }: OrganizerPasswordResetFormProps) {
    ...
    try {
      ...
      if (result.error) {
        ...
        logAuthError(result.error, {
          action: 'organizer_password_reset_attempt',
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Enter your organizer email address and we&apos;ll send you a link to reset your password.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
